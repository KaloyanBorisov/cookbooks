...
class SemanticInstructionSchema(BaseModel):
    ...
    reasoning: str = Field(default="", description="Explanation of why this action is needed")
...
class ExecutionState(BaseModel):
    ...
    # Configuration values (set during initialization)
    _iteration_limit: int = 30  # Default value, should be set from config
    ...
    def is_max_interactions_reached(self) -> bool:
        ...
        return self.interaction_count >= self._iteration_limit
    ...
    def get_interaction_summary(self) -> str:
        ...
        return f"Interaction {self.interaction_count}/{self._iteration_limit}"
